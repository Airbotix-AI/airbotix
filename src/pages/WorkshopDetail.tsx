    ...
    <div>
      ...
      <section className="bg-gradient-to-br from-primary-50 to-secondary-50 py-12 md:py-16">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <Link to="/workshops" className="text-primary-700 hover:underline">â†?Back to Workshops</Link>
          ...
          <div className="mt-3 text-gray-600">{item.targetAudience} â€?{item.duration}</div>
